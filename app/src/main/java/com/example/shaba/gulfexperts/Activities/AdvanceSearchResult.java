...
public class AdvanceSearchResult extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String major_message = intent.getStringExtra(AdvanceSearchActivity.Major_MESSAGE);
        String qualification_message = intent.getStringExtra(AdvanceSearchActivity.Qualification_MESSAGE);
        String country_message = intent.getStringExtra(AdvanceSearchActivity.Country_MESSAGE);
        ...
        //   CVData() ;
        List<AdvanceList> advanceLists= cvRepo.getAdvanceSearch(major_message, qualification_message ,country_message );
...
//
    ...
    private void addSeparator() {
        Resources res = AdvanceSearchResult.this.getResources();
        separator = new LinearLayout(AdvanceSearchResult.this);
